        ...
        <div className="w-1/2 p-8 flex flex-col">
          ...
          <div className="flex-grow flex flex-col justify-center">
            <div className="max-w-sm mx-auto w-full space-y-6">
              ...
              peer-checked:bg-[#424242] peer-checked:border-[#424242] 
              peer-checked:ring-2 peer-checked:ring-gray-700 transition-all duration-300"
                    ></div>
                  ...
                  <a
                    href="home"
                    className="text-sm text-[#0148FF] hover:underline font-bold "
                  >
                    Forgot Password?
                  </a>
                </div>
